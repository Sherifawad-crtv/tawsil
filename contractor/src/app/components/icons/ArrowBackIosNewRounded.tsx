...
/** Sourced from google/material-design-icons Material Symbols (ArrowBackIosNew, rounded, filled, 24px). */
export default function ArrowBackIosNewRounded(props: SvgIconProps) {
  return (
