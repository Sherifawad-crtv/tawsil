...
/** Sourced from google/material-design-icons Material Symbols (CheckCircle, rounded, filled, 24px). */
export default function CheckCircleRounded(props: SvgIconProps) {
  return (
