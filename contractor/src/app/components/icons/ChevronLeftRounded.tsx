...
/** Sourced from google/material-design-icons Material Symbols (ChevronLeft, rounded, filled, 24px). */
export default function ChevronLeftRounded(props: SvgIconProps) {
  return (
