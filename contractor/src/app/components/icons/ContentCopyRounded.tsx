...
/** Sourced from google/material-design-icons Material Symbols (content_copy, rounded, filled, 24px). */
export default function ContentCopyRounded(props: SvgIconProps) {
  return (
