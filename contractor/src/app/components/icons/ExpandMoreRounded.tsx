...
/** Sourced from google/material-design-icons Material Symbols (expand_more, rounded, filled, 24px). */
export default function ExpandMoreRounded(props: SvgIconProps) {
  return (
