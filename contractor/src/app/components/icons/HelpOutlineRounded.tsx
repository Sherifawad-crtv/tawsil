...
/** Sourced from google/material-design-icons Material Symbols (HelpOutline, rounded, filled, 24px). */
export default function HelpOutlineRounded(props: SvgIconProps) {
  return (
