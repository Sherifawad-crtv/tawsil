...
/** Sourced from google/material-design-icons Material Symbols (hourglass_empty, rounded, filled, 24px). */
export default function HourglassEmptyRounded(props: SvgIconProps) {
  return (
