...
/** Sourced from google/material-design-icons Material Symbols (manage_accounts, rounded, filled, 24px). */
export default function ManageAccountsRounded(props: SvgIconProps) {
  return (
