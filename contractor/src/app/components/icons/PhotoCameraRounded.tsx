...
/** Sourced from google/material-design-icons Material Symbols (photo_camera, rounded, filled, 24px). */
export default function PhotoCameraRounded(props: SvgIconProps) {
  return (
