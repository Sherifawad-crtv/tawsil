...
// Not confirmed by a Driver-specific screenshot per the doc - built consistent with Contractor's
// confirmed pattern (same radio position for both rows) as the safer default, flagged as an
// assumption rather than silently carried over.
    ...
    <div className="min-h-screen w-full flex flex-col" style={{ backgroundColor: "#F5F5F3" }}>
      ...
      <div className="w-full max-w-lg mx-auto px-6 pb-8 flex-1 flex flex-col">
        ...
        <div className="flex flex-col items-center gap-3 mt-8">
          ...
          <button onClick={() => navigate("/account")} className="cursor-pointer" style={{ fontFamily: "'Archivo', sans-serif", fontWeight: 600, fontSize: "13px", color: "#9CA3AF" }}>
            Skip for now
          </button>
        </div>
      </div>
