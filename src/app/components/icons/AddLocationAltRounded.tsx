...
/** Sourced from google/material-design-icons Material Symbols (AddLocationAlt, rounded, filled, 24px). */
export default function AddLocationAltRounded(props: SvgIconProps) {
  return (
