...
/** Sourced from google/material-design-icons Material Symbols (LocalShipping, rounded, filled, 24px). */
export default function LocalShippingRounded(props: SvgIconProps) {
  return (
