...
/** Sourced from google/material-design-icons Material Symbols (MailOutline, rounded, filled, 24px). */
export default function MailOutlineRounded(props: SvgIconProps) {
  return (
