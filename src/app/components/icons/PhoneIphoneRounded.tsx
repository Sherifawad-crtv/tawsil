...
/** Sourced from google/material-design-icons Material Symbols (PhoneIphone, rounded, filled, 24px). */
export default function PhoneIphoneRounded(props: SvgIconProps) {
  return (
