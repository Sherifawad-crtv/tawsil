...
/** Sourced from google/material-design-icons Material Symbols (PictureAsPdf, rounded, filled, 24px). */
export default function PictureAsPdfRounded(props: SvgIconProps) {
  return (
