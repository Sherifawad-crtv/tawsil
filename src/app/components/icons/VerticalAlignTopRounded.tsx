...
/** Sourced from google/material-design-icons Material Symbols (VerticalAlignTop, rounded, filled, 24px). */
export default function VerticalAlignTopRounded(props: SvgIconProps) {
  return (
